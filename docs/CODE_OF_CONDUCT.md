...
- Focus on what's best for the community and the people who use the product.
...
Applies to all project spaces — the repository, issues, pull requests, discussions, chat,
and any public space where someone is representing the project.
